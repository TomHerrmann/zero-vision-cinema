...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_events_v" (
  	...
  	"version_datetime" timestamp(3) with time zone,
  	"version_payment_link" varchar,
  	"version_product_id" varchar,
  	"version_price_id" varchar,
  	"version_ticket_limit" numeric,
  	"version_tickets_sold" numeric DEFAULT 0,
  ...
  ALTER TABLE "locations" ADD CONSTRAINT "locations_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "orders_rels" ADD CONSTRAINT "orders_rels_events_fk" FOREIGN KEY ("events_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "orders_rels" ADD CONSTRAINT "orders_rels_merch_fk" FOREIGN KEY ("merch_id") REFERENCES "public"."merch"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "locations_logo_idx" ON "locations" USING btree ("logo_id");
  CREATE INDEX "locations_updated_at_idx" ON "locations" USING btree ("updated_at");
  CREATE INDEX "locations_created_at_idx" ON "locations" USING btree ("created_at");
  CREATE INDEX "events_image_idx" ON "events" USING btree ("image_id");
  CREATE INDEX "events_location_idx" ON "events" USING btree ("location_id");
  CREATE UNIQUE INDEX "events_payment_link_idx" ON "events" USING btree ("payment_link");
  CREATE UNIQUE INDEX "events_product_id_idx" ON "events" USING btree ("product_id");
  CREATE UNIQUE INDEX "events_price_id_idx" ON "events" USING btree ("price_id");
  ...
  CREATE INDEX "_events_v_version_version_payment_link_idx" ON "_events_v" USING btree ("version_payment_link");
  CREATE INDEX "_events_v_version_version_product_id_idx" ON "_events_v" USING btree ("version_product_id");
  CREATE INDEX "_events_v_version_version_price_id_idx" ON "_events_v" USING btree ("version_price_id");
  ...
  CREATE UNIQUE INDEX "merch_product_id_idx" ON "merch" USING btree ("product_id");
  ...
  CREATE UNIQUE INDEX "orders_receipt_url_idx" ON "orders" USING btree ("receipt_url");
  ...
  CREATE INDEX "orders_rels_events_id_idx" ON "orders_rels" USING btree ("events_id");
  CREATE INDEX "orders_rels_merch_id_idx" ON "orders_rels" USING btree ("merch_id");
